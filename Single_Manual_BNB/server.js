...
const CFG = {
  BRAIN_NAME: envStr("BRAIN_NAME", "BrainFVVO_Swing_BNB_v1c_3COMMAS_V2_DUAL_SCHEMA_LIVE"),
...
function statusPayload() {
  return {
    ...
    c3ExecutionContract: {
      ...
      requiredBotEntryOrder: CFG.C3_EXECUTION_SCHEMA === "v2_custom_code" ? "amountPerTrade + quote + market" : "fixed quote amount + Market",
...
Object.assign(module.exports, { buildPosition, buildIntelligentTpState, evaluateIntelligentTpShadow, validC3V2Code, redactC3V2Code });
...
// ===== END SWING V1H ENGINE + C3 DYNAMIC-INSTRUMENT HOTFIX =====
  ...
  const SUPERVISOR = {
    brain: envStr("MULTI_BRAIN_NAME", "BrainFVVO_Swing_BNB_v1c_3COMMAS_V2_DUAL_SCHEMA_LIVE"),
  ...
  function buildWorkerSpec(alias, index) {
    ...
    childEnv.BRAIN_NAME = envStr(
      `${alias}_BRAIN_NAME`,
      envStr("BRAIN_NAME", "BrainFVVO_Swing_BNB_v1c_3COMMAS_V2_DUAL_SCHEMA_LIVE")
    );
