...
process.env.DYNAMIC_TP_TIER1_FORCE_EXIT_GIVEBACK_PCT = "0.40";
process.env.DYNAMIC_TP_TIER1_MIN_EXIT_PNL_PCT = "0.30";
// v6.6e-fix1 aliases: config.js supports both short and original long names.
process.env.DYNAMIC_TP_TIER1_FORCE_GIVEBACK_PCT = "0.40";
process.env.DYNAMIC_TP_TIER1_FORCE_MIN_EXIT_PNL_PCT = "0.30";
