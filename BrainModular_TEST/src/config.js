...
export const CONFIG = {
  ...
  BRAIN_NAME: s(process.env.BRAIN_NAME, "BrainRAY_Continuation_v6.6d_ATR_STRUCTURE_SYNC_ADAPTIVE_TP"),
  ...
  // v6.6d TP-protection fail-safe: dynamic/adaptive TP has priority over launch-hold protection once giveback is too large.
  ...
  // v6.6d Adaptive TP ladder: higher peaks get tighter giveback windows.
