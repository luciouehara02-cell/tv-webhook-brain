...
const CFG = {
  BRAIN_NAME: envStr("BRAIN_NAME", "BrainFVVO_Swing_BNB_v1a_TRAILING_DIP_CAMPAIGN_LIVE"),
...
// ===== END SWING V1H ENGINE + C3 DYNAMIC-INSTRUMENT HOTFIX =====
  ...
  const SUPERVISOR = {
    brain: envStr("MULTI_BRAIN_NAME", "BrainFVVO_Swing_BNB_v1a_TRAILING_DIP_CAMPAIGN_LIVE"),
  ...
  function buildWorkerSpec(alias, index) {
    ...
    childEnv.BRAIN_NAME = envStr(
      `${alias}_BRAIN_NAME`,
      envStr("BRAIN_NAME", "BrainFVVO_Swing_BNB_v1a_TRAILING_DIP_CAMPAIGN_LIVE")
    );
