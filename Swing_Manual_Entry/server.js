...
const CFG = {
  ...
  STATE_FILE_NAME: envStr("STATE_FILE_NAME", "brainfvvo-swing-v1f-demo-state.json"),
...
function normalizeState(raw) {
  ...
  // v1f schema migration marker: preserve compatible fields but always persist the current schema.
