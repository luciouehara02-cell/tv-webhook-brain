...
export const CONFIG = Object.freeze({
  ...
  ENABLE_HTTP_FORWARD: envBool(env.ENABLE_HTTP_FORWARD, false),
  ...
  STATE_FILE: env.STATE_FILE || "/data/brainswing-longrun-v1a-state.json", DEBUG: envBool(env.DEBUG, true),
  LOG_TICKS: envBool(env.LOG_TICKS, false), LOG_FEATURES: envBool(env.LOG_FEATURES, true), LOG_RAY_SIGNALS: envBool(env.LOG_RAY_SIGNALS, true),
