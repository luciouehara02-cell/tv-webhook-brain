...
export const CONFIG = {
  ...
  // v6.4 defensive exits: first-entry no-progress and thesis-failure protection
  FIRST_ENTRY_NO_PROGRESS_ENABLED: b(process.env.FIRST_ENTRY_NO_PROGRESS_ENABLED, false),
  FIRST_ENTRY_NO_PROGRESS_MIN_BARS: n(process.env.FIRST_ENTRY_NO_PROGRESS_MIN_BARS, 6),
  FIRST_ENTRY_NO_PROGRESS_MAX_BARS: n(process.env.FIRST_ENTRY_NO_PROGRESS_MAX_BARS, 10),
  FIRST_ENTRY_NO_PROGRESS_MIN_PEAK_PCT: n(process.env.FIRST_ENTRY_NO_PROGRESS_MIN_PEAK_PCT, 0.25),
  FIRST_ENTRY_NO_PROGRESS_MAX_CURRENT_PCT: n(process.env.FIRST_ENTRY_NO_PROGRESS_MAX_CURRENT_PCT, 0.10),
  FIRST_ENTRY_NO_PROGRESS_EXIT_IF_CLOSE_BELOW_EMA8: b(process.env.FIRST_ENTRY_NO_PROGRESS_EXIT_IF_CLOSE_BELOW_EMA8, true),
  FIRST_ENTRY_NO_PROGRESS_EXIT_IF_CLOSE_BELOW_EMA18: b(process.env.FIRST_ENTRY_NO_PROGRESS_EXIT_IF_CLOSE_BELOW_EMA18, false),
  FIRST_ENTRY_NO_PROGRESS_RSI_BELOW: n(process.env.FIRST_ENTRY_NO_PROGRESS_RSI_BELOW, 52),
  FIRST_ENTRY_NO_PROGRESS_REQUIRE_NOT_BULLISH_FVVO: b(process.env.FIRST_ENTRY_NO_PROGRESS_REQUIRE_NOT_BULLISH_FVVO, true),
  FIRST_ENTRY_NO_PROGRESS_REQUIRE_ENTRY_MODE_FIRST: b(process.env.FIRST_ENTRY_NO_PROGRESS_REQUIRE_ENTRY_MODE_FIRST, true),
  FIRST_ENTRY_NO_PROGRESS_LOG: b(process.env.FIRST_ENTRY_NO_PROGRESS_LOG, true),

  FIRST_ENTRY_THESIS_FAIL_ENABLED: b(process.env.FIRST_ENTRY_THESIS_FAIL_ENABLED, false),
  FIRST_ENTRY_THESIS_FAIL_MIN_BARS: n(process.env.FIRST_ENTRY_THESIS_FAIL_MIN_BARS, 4),
  FIRST_ENTRY_THESIS_FAIL_MAX_BARS: n(process.env.FIRST_ENTRY_THESIS_FAIL_MAX_BARS, 18),
  FIRST_ENTRY_THESIS_FAIL_MIN_LOSS_PCT: n(process.env.FIRST_ENTRY_THESIS_FAIL_MIN_LOSS_PCT, -0.25),
  FIRST_ENTRY_THESIS_FAIL_MAX_PEAK_PCT: n(process.env.FIRST_ENTRY_THESIS_FAIL_MAX_PEAK_PCT, 0.10),
  FIRST_ENTRY_THESIS_FAIL_RSI_BELOW: n(process.env.FIRST_ENTRY_THESIS_FAIL_RSI_BELOW, 50),
  FIRST_ENTRY_THESIS_FAIL_REQUIRE_CLOSE_BELOW_EMA18: b(process.env.FIRST_ENTRY_THESIS_FAIL_REQUIRE_CLOSE_BELOW_EMA18, true),
  FIRST_ENTRY_THESIS_FAIL_REQUIRE_CLOSE_BELOW_EMA8: b(process.env.FIRST_ENTRY_THESIS_FAIL_REQUIRE_CLOSE_BELOW_EMA8, false),
  FIRST_ENTRY_THESIS_FAIL_REQUIRE_NOT_BULLISH_FVVO: b(process.env.FIRST_ENTRY_THESIS_FAIL_REQUIRE_NOT_BULLISH_FVVO, true),
  FIRST_ENTRY_THESIS_FAIL_REQUIRE_ENTRY_MODE_FIRST: b(process.env.FIRST_ENTRY_THESIS_FAIL_REQUIRE_ENTRY_MODE_FIRST, true),
  FIRST_ENTRY_THESIS_FAIL_LOG: b(process.env.FIRST_ENTRY_THESIS_FAIL_LOG, true),
  ...
  // v6.6e TP-protection fail-safe: dynamic/adaptive TP has priority over launch-hold protection once giveback is too large.
  LAUNCH_TP_PROTECTION_FORCE_ALLOW_ON_MAX_GIVEBACK: b(
    process.env.LAUNCH_TP_PROTECTION_FORCE_ALLOW_ON_MAX_GIVEBACK,
    true
  ),
  ...
  DYNAMIC_TP_ADAPTIVE_LOG: b(process.env.DYNAMIC_TP_ADAPTIVE_LOG, true),
  DYNAMIC_TP_MIN_GROSS_EXIT_PNL_PCT: n(process.env.DYNAMIC_TP_MIN_GROSS_EXIT_PNL_PCT, 0.35),
  DYNAMIC_TP_MIN_NET_EXIT_PNL_PCT: n(process.env.DYNAMIC_TP_MIN_NET_EXIT_PNL_PCT, 0.10),
  FEE_ROUND_TRIP_PCT: n(process.env.FEE_ROUND_TRIP_PCT, 0.15),
  SLIPPAGE_BUFFER_PCT: n(process.env.SLIPPAGE_BUFFER_PCT, 0.05),

  DYNAMIC_TP_PROFILE_FIRST_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_ARM_PCT, 0.30),
  DYNAMIC_TP_PROFILE_FIRST_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_TIER1_PCT, 0.60),
  DYNAMIC_TP_PROFILE_FIRST_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_MID_PCT, 0.90),
  DYNAMIC_TP_PROFILE_FIRST_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_TIER2_PCT, 1.20),
  DYNAMIC_TP_PROFILE_FIRST_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_ABOVE_PCT, 1.50),
  DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_ARM_PCT, 0.35),
  DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_TIER1_PCT, 0.25),
  DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_MID_PCT, 0.18),
  DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_TIER2_PCT, 0.12),
  DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_FIRST_GIVEBACK_ABOVE_PCT, 0.10),

  DYNAMIC_TP_PROFILE_REENTRY_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_ARM_PCT, 0.25),
  DYNAMIC_TP_PROFILE_REENTRY_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_TIER1_PCT, 0.50),
  DYNAMIC_TP_PROFILE_REENTRY_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_MID_PCT, 0.75),
  DYNAMIC_TP_PROFILE_REENTRY_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_TIER2_PCT, 1.00),
  DYNAMIC_TP_PROFILE_REENTRY_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_ABOVE_PCT, 1.25),
  DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_ARM_PCT, 0.28),
  DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_TIER1_PCT, 0.20),
  DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_MID_PCT, 0.15),
  DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_TIER2_PCT, 0.10),
  DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_REENTRY_GIVEBACK_ABOVE_PCT, 0.08),

  DYNAMIC_TP_PROFILE_STRONG_REENTRY_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_ARM_PCT, 0.30),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_TIER1_PCT, 0.60),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_MID_PCT, 0.90),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_TIER2_PCT, 1.20),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_ABOVE_PCT, 1.50),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_ARM_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_ARM_PCT, 0.32),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_TIER1_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_TIER1_PCT, 0.22),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_MID_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_MID_PCT, 0.16),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_TIER2_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_TIER2_PCT, 0.10),
  DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_ABOVE_PCT: n(process.env.DYNAMIC_TP_PROFILE_STRONG_REENTRY_GIVEBACK_ABOVE_PCT, 0.08),

  DYNAMIC_TP_ONE_BAR_PULLBACK_ENABLED: b(process.env.DYNAMIC_TP_ONE_BAR_PULLBACK_ENABLED, true),
  DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_PEAK_PCT: n(process.env.DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_PEAK_PCT, 0.60),
  DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_GIVEBACK_PCT: n(process.env.DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_GIVEBACK_PCT, 0.08),
  DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_EXIT_PNL_PCT: n(process.env.DYNAMIC_TP_ONE_BAR_PULLBACK_MIN_EXIT_PNL_PCT, 0.35),

  // v6.6e post-adaptive-TP reentry gate: wait for real reset, then require reclaim.
  POST_ADAPTIVE_TP_REENTRY_ENABLED: b(process.env.POST_ADAPTIVE_TP_REENTRY_ENABLED, true),
  POST_ADAPTIVE_TP_REENTRY_COOLDOWN_BARS: n(process.env.POST_ADAPTIVE_TP_REENTRY_COOLDOWN_BARS, 2),
  POST_ADAPTIVE_TP_REENTRY_WINDOW_BARS: n(process.env.POST_ADAPTIVE_TP_REENTRY_WINDOW_BARS, 48),
  POST_ADAPTIVE_TP_REENTRY_REQUIRE_RESET: b(process.env.POST_ADAPTIVE_TP_REENTRY_REQUIRE_RESET, true),
  POST_ADAPTIVE_TP_REENTRY_MIN_RESET_FROM_PEAK_PCT: n(process.env.POST_ADAPTIVE_TP_REENTRY_MIN_RESET_FROM_PEAK_PCT, 0.70),
  POST_ADAPTIVE_TP_REENTRY_MIN_RESET_FROM_EXIT_PCT: n(process.env.POST_ADAPTIVE_TP_REENTRY_MIN_RESET_FROM_EXIT_PCT, 0.45),
  POST_ADAPTIVE_TP_REENTRY_ALLOW_EMA8_TOUCH_RESET: b(process.env.POST_ADAPTIVE_TP_REENTRY_ALLOW_EMA8_TOUCH_RESET, false),
  POST_ADAPTIVE_TP_REENTRY_ALLOW_EMA18_TOUCH_RESET: b(process.env.POST_ADAPTIVE_TP_REENTRY_ALLOW_EMA18_TOUCH_RESET, true),
  POST_ADAPTIVE_TP_REENTRY_REQUIRE_RECLAIM: b(process.env.POST_ADAPTIVE_TP_REENTRY_REQUIRE_RECLAIM, true),
  POST_ADAPTIVE_TP_REENTRY_RECLAIM_MIN_RSI: n(process.env.POST_ADAPTIVE_TP_REENTRY_RECLAIM_MIN_RSI, 58),
  POST_ADAPTIVE_TP_REENTRY_RECLAIM_MIN_ADX: n(process.env.POST_ADAPTIVE_TP_REENTRY_RECLAIM_MIN_ADX, 18),
  POST_ADAPTIVE_TP_REENTRY_REQUIRE_CLOSE_ABOVE_EMA8: b(process.env.POST_ADAPTIVE_TP_REENTRY_REQUIRE_CLOSE_ABOVE_EMA8, true),
  POST_ADAPTIVE_TP_REENTRY_REQUIRE_EMA8_ABOVE_EMA18: b(process.env.POST_ADAPTIVE_TP_REENTRY_REQUIRE_EMA8_ABOVE_EMA18, true),
  POST_ADAPTIVE_TP_REENTRY_BLOCK_BEARISH_FVVO_SEC: n(process.env.POST_ADAPTIVE_TP_REENTRY_BLOCK_BEARISH_FVVO_SEC, 300),
  POST_ADAPTIVE_TP_REENTRY_MAX_CHASE_FROM_RECLAIM_PCT: n(process.env.POST_ADAPTIVE_TP_REENTRY_MAX_CHASE_FROM_RECLAIM_PCT, 0.35),
  POST_ADAPTIVE_TP_REENTRY_MIN_GREEN_BODY_PCT: n(process.env.POST_ADAPTIVE_TP_REENTRY_MIN_GREEN_BODY_PCT, 0.04),
  POST_ADAPTIVE_TP_REENTRY_REQUIRE_GREEN_BODY: b(process.env.POST_ADAPTIVE_TP_REENTRY_REQUIRE_GREEN_BODY, false),
  POST_ADAPTIVE_TP_REENTRY_LOG: b(process.env.POST_ADAPTIVE_TP_REENTRY_LOG, true),
