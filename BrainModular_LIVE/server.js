...
app.listen(CONFIG.PORT, () => {
  ...
  log("🧠 CONFIG_SNAPSHOT", {
    ...
    dynamicTpProtection: {
      enabled: CONFIG.DYNAMIC_TP_ENABLED,
      tier1ArmPct: CONFIG.DTP_TIER1_ARM_PCT,
      tier1GivebackPct: CONFIG.DTP_TIER1_GIVEBACK_PCT,
      launchProtectionEnabled: CONFIG.LAUNCH_TP_PROTECTION_ENABLED,
      maxGivebackPct: CONFIG.LAUNCH_TP_PROTECTION_MAX_GIVEBACK_PCT,
      disableOnBearishFvvo: CONFIG.LAUNCH_TP_PROTECTION_DISABLE_ON_BEARISH_FVVO,
      disableBelowEma8: CONFIG.LAUNCH_TP_PROTECTION_DISABLE_BELOW_EMA8,
      tier1ForceExitGivebackPct: CONFIG.DYNAMIC_TP_TIER1_FORCE_EXIT_GIVEBACK_PCT,
      tier1MinExitPnlPct: CONFIG.DYNAMIC_TP_TIER1_MIN_EXIT_PNL_PCT,
    },
  });
});
