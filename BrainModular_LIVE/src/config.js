...
export const CONFIG = {
  ...
  BRAIN_NAME: s(process.env.BRAIN_NAME, "BrainRAY_Continuation_v6.5b_tp_protection_fix_LIVE"),
  ...
  // v6.5c TP-protection fail-safe: do not let launch protection block tier-1 TP forever
